...
let SALES_URL = 'http://' + host + ':' + port + '/gateway/sales';

let WAREHOUSE_HEALTH_URL = 'http://' + host + ':' + port + '/gateway/warehouse/health';
let WAREHOUSE_URL = 'http://' + host + ':' + port + '/gateway/warehouse';
