...
public class CustomerGetByIdCommandConsumer extends DefaultConsumer {
    private static final Logger logger = LogManager.getLogger(CustomerGetByIdCommandConsumer.class);

    public CustomerGetByIdCommandConsumer(Channel channel) {
        super(channel);
    }
    ...
    public void handleDelivery(String consumerTag, Envelope envelope,
        ...
        CustomerDto customerDto = customerRepository.getById(customerGetByIdDto.getCustomerId());

        String customerDtosJson = new JsonConverterFactory<CustomerDto>()
                .get().toJson(customerDto);
