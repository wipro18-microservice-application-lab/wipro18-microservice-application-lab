...
public class EventBroker {
    ...
    public void undoLast() {
        ...
        if (e instanceof ArticleStockChangedEvent) {
            ArticleStockChangedEvent asce = (ArticleStockChangedEvent) e;
            command(new ChangeArticleStockCommand(asce.articleId, asce.newValue - asce.oldValue));
        }
    }
